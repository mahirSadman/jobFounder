            ...
            <div id="accordion">
                <div class="d-flex" id="headingThree">
                    <h5 class="collapsed mb-0 headerTextMiddle"data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                     Posted Jobes(3)<i class="fa fa-sort-desc" aria-hidden="true"></i>
                    </h5>
                    <a href="post_job_create.html" class="btn btn-success ml-auto">
                        Post a new job
                    </a>
                </div>
                    ...
                    <div class="card-body">
                      <ol class="mx-5"> 
                        <li>
                            <div class="row">
                                <div class="col-8">
                                    <a class="text-primary font-weight-bold" href="post_job_view.html">Web desiging</a>
                                    <p>Salary: 30000Tk</p>
                                </div>
                                <div class="col-4">
                        ...
                        <li>
                            <div class="row">
                                <div class="col-8">
                                    <a class="text-primary font-weight-bold" href="post_job_view.html">Recieptionist</a>
                                    <p>Salary:15000Tk</p>
                                </div>
                                <div class="col-4">
                                    <a class="btn btn-sm btn-danger" href="#">Cancel</a>
                        ...
                        <li>
                            <div class="row">
                                <div class="col-8">
                                    <a class="text-primary font-weight-bold" href="post_job_view.html">Accountant</a>
                                    <p>Salary: 25000</p>
                                </div>
                                <div class="col-4">
                                    <a class="btn btn-sm btn-danger" href="#">Cancel</a>
